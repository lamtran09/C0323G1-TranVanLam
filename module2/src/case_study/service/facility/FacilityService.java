...
public class FacilityService implements IFacilityService {
    ...
    public void displayFacilityMaintain() {
        List<Facility> facilityList = facilityRepository.displayFacilityMaintain();
...
//                String idService, String nameService, float usableArea, long rentalCosts, int maximumPeople, String rentalType, String roomStandard, float swimmingArea, int numberOfFloors
                ...
                } while (!Regex.validateIdServiceVilla(idService));
                String nameService;
                do {
                    System.out.println("Nhập tên dịch vụ");
                    nameService = scanner.nextLine();
                } while (!Regex.validateNamePerson(nameService));
                float usableArea;
                while (true) {
                    try {
...
//                String roomStandard, float swimmingArea, int numberOfFloors
    ...
    public void addNewHouse() {
        ...
        do {
            ...
            idService = scanner.nextLine();
        } while (!Regex.validateIdServiceHouse(idService));
        String nameService;
        do {
            System.out.println("Nhập tên dịch vụ");
            nameService = scanner.nextLine();
    ...
    public void addNewRoom() {
        ...
        do {
            ...
            idService = scanner.nextLine();
        } while (!Regex.validateIdServiceRoom(idService));
        String nameService;
        do {
            System.out.println("Nhập tên dịch vụ");
            nameService = scanner.nextLine();
