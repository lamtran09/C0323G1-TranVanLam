...
public class House extends Facility {
     ...
     * @date : 28/05/2023
     */
    public House(int idService, String nameService, float usableArea, float rentalCosts, int maximumPeople, String rentalType, String roomStandard, int numberOfFloors) {
